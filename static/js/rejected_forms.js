...
async function populateRejectedFormsTable() {
    try {
...
async function requestReanalysis(formId) {
    const response = await fetchWithAuth(`/entrevista-adesao/application-forms/${formId}/request-reanalysis`, {
        method: "POST",
    });
...
async function closeNegotiation(formId) {
    const response = await fetchWithAuth(`/entrevista-adesao/application-forms/${formId}/close-negotiation`, {
        method: "POST",
    });
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    document.getElementById("tbodyRejectedForms").addEventListener("click", async (event) => {
